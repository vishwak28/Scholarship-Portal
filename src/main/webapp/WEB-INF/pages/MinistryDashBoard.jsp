			...
			<div class="panel panel-default">
				...
				<div class="list-group">
					<a href="#" class="list-group-item">My Account</a> <a
						...
						Application Forms</a> <a href="viewins_data" class="list-group-item">Institute
						Application Forms</a> <a href="logout" class="list-group-item">Logout</a>
				...
				<article class="col-xs-12">
					<div class="media">
						<div class="media-body">
							<h2 class="media-heading">Guidelines For Ministry</h2>
							<p>Ministers are allowed to verify the scholarship of the
								applying students and the request received from the
								Institute.Ministry needs to verify the documents and grant
								scholarship to students and give permission for the Institute.</p>
						</div>
					</div>
				</article>
			</div>
